package io.hspx.recipe.bootstrap;

import io.hspx.recipe.domain.*;
import io.hspx.recipe.repositories.CategoryRepository;
import io.hspx.recipe.repositories.RecipeRepository;
import io.hspx.recipe.repositories.UnitOfMeasureRepository;
...
public class DataSeed implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public DataSeed(CategoryRepository categoryRepository, RecipeRepository recipeRepository, UnitOfMeasureRepository unitOfMeasureRepository) {
    ...
    private List<Recipe> getRecipes() {
        log.debug("Bootstrapping seed data...");
